...
/// </summary>
public class ProductAccess : IDataAccess<ProductEntity>
{
    private static readonly IEnumerable<ProductEntity> ProductDatabase = new List<ProductEntity>()
    {
    ...
    public IEnumerable<ProductEntity> List(int? pageStart, int? pageSize)
    {
